...
| [RESUNET3D.md](RESUNET3D.md) | Native 3-D residual U-Net baseline and ImageNet transfer boundary |
| [SWINUNETR.md](SWINUNETR.md) | MONAI SwinUNETR adapter and native 3-D baseline path |
| [TRANSUNET.md](TRANSUNET.md) | External 2-D slice adapter, checkout boundary, and canonical output conversion |
| [CNN_PRETRAINING.md](CNN_PRETRAINING.md) | Separate ImageFolder denoising pretraining and encoder export |
